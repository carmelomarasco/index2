...
public class AuthServiceLocator extends com.ibm.ws.webservices.engine.client.Service implements it.finanze.security.webservices.ct.AuthService {
    ...
    private final java.lang.String auth_address = "https://gestaccessival.sogei.it/WSAuthWeb/services/Auth";
    ...
    public it.finanze.security.webservices.ct.Auth getAuth() throws javax.xml.rpc.ServiceException {
       java.net.URL endpoint;
        try {
            ...
            return null; // diversamente da come � stato convalidato lURL in WSDL2Java
        }
	...
	public javax.xml.rpc.Call[] getCalls(javax.xml.namespace.QName portName) throws javax.xml.rpc.ServiceException {
        if (portName == null) {
            throw new javax.xml.rpc.ServiceException("WSWS3062E: Errore: Il nome porta non pu� essere nullo.");
        }
